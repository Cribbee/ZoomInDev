...
class Publish(models.Model):
    ...
    owner = models.ForeignKey(User, models.CASCADE, null=True, verbose_name="分享者用户")
    user = models.ForeignKey(User, models.CASCADE, null=True, verbose_name="被分享者用户")
    source_task = models.ForeignKey(TaskInfo, models.CASCADE, verbose_name="源任务", help_text="源任务id")
    task = models.ForeignKey(TaskInfo, models.CASCADE, default=-1, verbose_name="源任务", help_text="源任务id")
    ...
    class Meta:
        ...
        verbose_name_plural = verbose_name
        #联合字段构成唯一集合，避免重复收藏
        unique_together = ("owner", "task_name")
